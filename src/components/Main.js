...
// To render single image on gallery
...
var AppComponent = React.createClass({
  ...
  /*
   * re-arrange all pictures in this function
   * @param centerIndex - specify which picuture will be in center
   */
  	...
  	return {
  		imgsArrangeArr:[
  		    /*{
  		    	...
  		    	isInverse: false, // image inversed?
  		    	isCenter: false // image in center?
  		    }*/
  		]
  	};
  },
  ...
  componentDidMount: function() {
    ...
    // get center picture position coordinate
  	this.Constant.centerPos = {
  		left: halfStageW - halfImgW,
  		top: halfStageH - halfImgH
  	};

    // calculate left/right section X/Y range
    ...
    // calculate top section X/Y range
